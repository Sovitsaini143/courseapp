...
function Courses() {
  ...
  return (
    <div className="flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-gray-100 w-72 p-5 transform z-10 transition-transform duration-300 ease-in-out ${
      ...
      {/* Main content */}
      <main className="ml-0 md:ml-8 w-full bg-white p-10">
